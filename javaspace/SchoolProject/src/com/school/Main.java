...
public class Main {
	...
	private ArrayList trText = new ArrayList();
	private int i=0;
	...
	private void initialize() {
		...
		btnSettings.setBounds(50, 66, 115, 92);
		...
		btnExams.setBounds(349, 180, 105, 92);
			...
			public void actionPerformed(ActionEvent arg0) {
		         ...
		         {    
					 ...
					 String gender = (String)comboBox_1.getSelectedItem();
					  ...
					  st.execute("insert into students values('"+name+"','"+age+"','"+dob+"','"+phone+"','"+userId+"','"+pwd+"','"+section+"','"+fname+"','"+mname+"','"+house+"','"+Nationality+"','"+fees+"','"+gender+"','"+cls+"')");
		...
		try{
			...
			int row=1;
			while(rs.next()){
				tablemodel.addRow(new Object[]{row++, rs.getString(1), rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6)});
			...
			public void actionPerformed(ActionEvent event) {
				...
				try{
					...
					while(rs.next()){
						...
						//tablemodel.addRow(new Object[]{row++, trText.get(i), rs.getString(i+1),rs.getString(i+2),rs.getString(i+3),rs.getString(i+4),rs.getString(i+5)});
						tablemodel.addRow(new Object[]{row++, "hi", "hello", "kem chho", "maja ma","u r ","crazy"});
